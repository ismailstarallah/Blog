...
const Side_Bar = ({ setCategory, setSubcategory }) => {
  ...
  return (
    <>
      <p className='mx-[20%] my-4 text-black text-xl font-bold font-inria-serif leading-loose'>suggested books</p>
      <PopularBook limit={1} />
      ...
      <p className='mx-[20%] my-4 text-black text-xl font-bold font-inria-serif leading-loose'>Popular books</p>
